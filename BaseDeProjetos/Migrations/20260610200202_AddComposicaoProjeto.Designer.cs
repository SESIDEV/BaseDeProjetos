...
namespace BaseDeProjetos.Migrations
{
    ...
    [Migration("20260610200202_AddComposicaoProjeto")]
    partial class AddComposicaoProjeto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseDeProjetos.Models.IndicadoresFinanceiros", b =>
                {
                    ...
                    b.Property<int>("QtdPesquisadores")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaseDeProjetos.Models.IndicadoresPlanejamentoMensal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Casa", "Ano", "Indicador", "Coluna")
                        .IsUnique();

                    b.ToTable("IndicadoresPlanejamentoMensal");
                });

            modelBuilder.Entity("BaseDeProjetos.Models.IndicadoresReceitaGestor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ParceiroInterno")
                        .HasColumnType("varchar(120) CHARACTER SET utf8mb4")
                        .HasMaxLength(120);

                    b.Property<decimal?>("ProjecaoAno1")
                        .HasColumnType("decimal(65,30)");

                    b.Property<decimal?>("ProjecaoAno2")
                        .HasColumnType("decimal(65,30)");

                    b.Property<decimal?>("ProjecaoAno3")
                        .HasColumnType("decimal(65,30)");

                    b.Property<decimal?>("ProjecaoAno4")
                        .HasColumnType("decimal(65,30)");

                    b.Property<decimal?>("ProjecaoAno5")
                        .HasColumnType("decimal(65,30)");

                    b.Property<decimal?>("ReceitaAnoBase")
                        .HasColumnType("decimal(65,30)");
                    ...
                    b.HasIndex("Casa", "AnoBase", "Ordem");

                    b.ToTable("IndicadoresReceitaGestor");
                });
            ...
            modelBuilder.Entity("BaseDeProjetos.Models.Projeto", b =>
                {
                    ...
                    b.Property<int?>("ConjuntoRubricasId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PapelNaComposicao")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<string>("ProjetoPaiId")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.Property<double?>("ValorParticipacaoComposicao")
                        .HasColumnType("double");
                    ...
                    b.HasIndex("ConjuntoRubricasId");

                    b.HasIndex("EmpresaId");

                    b.HasIndex("ProjetoPaiId");
            ...
            modelBuilder.Entity("BaseDeProjetos.Models.Projeto", b =>
                {
                    b.HasOne("BaseDeProjetos.Models.ConjuntoRubrica", "ConjuntoRubricas")
                        .WithMany()
                        .HasForeignKey("ConjuntoRubricasId");

                    b.HasOne("BaseDeProjetos.Models.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("EmpresaId");

                    b.HasOne("BaseDeProjetos.Models.Projeto", "ProjetoPai")
                        .WithMany("ProjetosFilhos")
                        .HasForeignKey("ProjetoPaiId")
